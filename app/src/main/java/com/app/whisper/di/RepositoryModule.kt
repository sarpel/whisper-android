 ...
 *
 * This module provides the dependency injection bindings for all repository interfaces used
 * throughout the application, following the repository pattern for clean architecture separation.
 */
@Module
...
abstract class RepositoryModule {
         ...
         * - Audio transcription operations with Whisper.cpp
         * - Session management
